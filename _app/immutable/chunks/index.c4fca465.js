...
7. **Interoperabilidade Java**: Kotlin é projetado para ser totalmente interoperável com Java, permitindo que desenvolvedores aproveitem bibliotecas e frameworks Java existentes. Isso torna fácil adotar Kotlin em projetos Java existentes, permitindo que ambas as linguagens sejam usadas em o mesmo projeto.`,n={description:r},t={description:s},d={description:e},c={description:a},m={description:o},p={description:i},u={java:t,javascript:d,typescript:c,react:m,rust:p,kotlin:n};export{u as default};
